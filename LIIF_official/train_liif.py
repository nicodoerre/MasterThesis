...
import re
import warnings
warnings.filterwarnings("ignore", category=UserWarning, message=re.escape("torch.meshgrid: in an upcoming release"))
...
def main(config_, save_path):
    ...
    for epoch in range(epoch_start, epoch_max + 1):
        ...
        print(f" Epoch [{epoch}/{epoch_max}] - Training Loss: {train_loss:.6f}") #added
